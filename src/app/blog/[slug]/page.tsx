...
export async function generateMetadata({ params }: { params: { slug: string } }): Promise<Metadata> {
  ...
  if (!post) {
    return {
      title: "ไม่พบบทความ | ต้นไม้มงคล",
      description: "ไม่พบบทความที่คุณต้องการ กรุณาเลือกบทความอื่น"
    };
  }
  
  const metaDescription = post.excerpt || `${post.title} - บทความเกี่ยวกับต้นไม้มงคลและวิธีการดูแล`;
