...
export default function ProductFilters({ filters, onFilterChange }: ProductFiltersProps) {
  ...
  const isFilterActive = localFilters.category || localFilters.status || localFilters.searchTerm;
  ...
  return (
    <Box>
          ...
          <Stack direction="row" spacing={1} flexWrap="wrap" useFlexGap>
            ...
            {localFilters.status && (
              <Chip 
                ...
                variant="outlined"
                icon={localFilters.status === 'on' ? <VisibilityIcon fontSize="small" /> : <VisibilityOffIcon fontSize="small" />}
              />
            )}
      ...
      <Typography variant="subtitle2" gutterBottom color="text.secondary" sx={{ mt: 3, mb: 1.5, fontWeight: 500 }}>
        ตัวกรองขั้นสูง
      </Typography>
